...
#Calculate the Length and the Diameter
    def add_Measure(self,edit):
        ...
        expression1 = QgsExpression('''case when "Interpr" = 'Linear' then $perimeter/2 when "Interpr" = 'Grave' then $perimeter/2 when "Interpr" = 'Structure' then $perimeter/2 end ''')
        expression2 = QgsExpression('''case when "Interpr" = 'Pit' then $perimeter/3.14159265 when "Interpr" = 'Posthole' then $perimeter/3.14159265  when "Interpr" = 'Cremation' then $perimeter/3.14159265 end ''')
        context = QgsExpressionContext()
        context.appendScopes(QgsExpressionContextUtils.globalProjectLayerScopes(vl))
